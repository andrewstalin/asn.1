...
//#include "asn1/decoders/header_decoder.h"
//#include "asn1/encoders/encoder.h"
//#include "asn1/io/buffered.h"
//
//using namespace asn1;
//
//static void TestHeader(const Header& expected_header, const std::vector<uint8_t>& expected_data)
//{
//	io::BufferedWriter writer;
//	BerEncoder encoder;
//	encoder.encode_header(writer, expected_header.tag, expected_header.content_length);
//	CompareVectors(expected_data, std::vector<uint8_t>(writer.data(), writer.data() + writer.size()));
//
//	HeaderDecoder decoder;
//	auto test_data = GetTestData(expected_data);
//
...
//}
//
//TEST(ber_header_case, constructed_form_test)
//{
//	Header header({ EncodingForm::CONSTRUCTED, TagClass::APPLICATION, 27 }, 0);
//	std::vector<uint8_t> data = { 0x7B, 0x00 };
//	TestHeader(header, data);
//}
//
//TEST(ber_header_case, long_identifier_test)
//{
//	Header header({ EncodingForm::PRIMITIVE, TagClass::APPLICATION, 313 }, 0);
//	std::vector<uint8_t> data = { 0x5F, 0x82, 0x39, 0x00 };
//	TestHeader(header, data);
//}
//
//TEST(ber_header_case, undefinite_length_test)
//{
//	Header header({ EncodingForm::CONSTRUCTED, TagClass::APPLICATION, 27 }, INDEFINITE_CONTENT_LENGTH);
//	std::vector<uint8_t> data = { 0x7B, 0x80 };
//	TestHeader(header, data);
//}
//
//TEST(ber_header_case, short_length_test)
//{
//	Header header({ EncodingForm::CONSTRUCTED, TagClass::APPLICATION, 27 }, 90);
//	std::vector<uint8_t> data = { 0x7B, 0x5A };
//	TestHeader(header, data);
//}
//
//TEST(ber_header_case, long_length_test)
//{
//	Header header({ EncodingForm::CONSTRUCTED, TagClass::APPLICATION, 27 }, 302);
//	std::vector<uint8_t> data = { 0x7B, 0x82, 0x01, 0x2E };
//	TestHeader(header, data);
//}